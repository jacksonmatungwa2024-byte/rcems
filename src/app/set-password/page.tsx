...
export default function SetPasswordPage() {
  ...
  try {
    ...
    if (!res.ok) {
      setMessage(`❌ Imeshindikana kuweka nenosiri: ${result.error || "Unknown error"}`)
      return
    }
    ...
    if (dbError) {
      setMessage("✅ Nenosiri limebadilishwa, lakini metadata haikuweza kusasishwa.")
    } else {
      ...
      {canProceed ? (
        <>
          ...
          <input
            ...
            style={inputStyle}
          />
          <button onClick={handleSubmit} style={btnStyle}>✅ Weka Nenosiri</button>
        </>
      ) : (
